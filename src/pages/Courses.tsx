...
const courses = [
  ...
  },
  {
    ...
    rating: 4.7,
    popular: false,
    teacher: "Mrs. Nalini Desai"
  },
  {
    id: 9,
    title: "Commerce Classes",
    description: "Comprehensive commerce education for Class 11-12 with expert faculty, covering all major subjects including Accounts, Business Studies, and Economics.",
    wing: "senior",
    icon: <Briefcase className="h-8 w-8" />,
    color: "from-purple-600 to-indigo-600",
    cardBg: "from-purple-50 to-indigo-50 dark:from-purple-950/30 dark:to-indigo-950/30",
    iconBg: "bg-gradient-to-br from-purple-100 to-indigo-100 dark:from-purple-900/40 dark:to-indigo-900/40",
  ...
  {
    id: 10,
    title: "Commerce (11th-12th Class)",
    description: "Specialized classes for Commerce students of 11th and 12th grade, covering Accounts, Business Studies, Economics, Mathematics, and Python.",
    wing: "senior",
    icon: <Briefcase className="h-8 w-8" />,
    color: "from-yellow-600 to-amber-600",
    cardBg: "from-yellow-50 to-amber-50 dark:from-yellow-950/30 dark:to-amber-950/30",
    iconBg: "bg-gradient-to-br from-yellow-100 to-amber-100 dark:from-yellow-900/40 dark:to-amber-900/40",
    borderColor: "hover:border-yellow-500/50 hover:shadow-yellow-500/20",
    features: ["Accounts", "Business Studies", "Economics", "Mathematics", "Python"],
    rating: 4.9,
    popular: true,
  ...
  // Junior Wing Courses
  {
    ...
    borderColor: "hover:border-blue-400/50 hover:shadow-blue-400/20",
  ...
  },
  {
    ...
    borderColor: "hover:border-green-400/50 hover:shadow-green-400/20",
  ...
  },
  {
    ...
    cardBg: "from-amber-50 to-orange-50 dark:from-amber-950/20 dark:to-orange-950/20",
    iconBg: "bg-gradient-to-br from-amber-100 to-orange-100 dark:from-amber-900/30 dark:to-orange-900/30",
    borderColor: "hover:border-amber-400/50 hover:shadow-amber-400/20",
  ...
  },
  {
    ...
    cardBg: "from-purple-50 to-indigo-50 dark:from-purple-950/20 dark:to-indigo-950/20",
    iconBg: "bg-gradient-to-br from-purple-100 to-indigo-100 dark:from-purple-900/30 dark:to-indigo-900/30",
    borderColor: "hover:border-purple-400/50 hover:shadow-purple-400/20",
  ...
  },
  {
    id: 20,
    title: "English",
    description: "Enhancing reading, writing, and communication skills with creative learning approaches for young students.",
    subject: "English",
    wing: "junior",
    icon: <BookOpen className="h-8 w-8" />,
    color: "from-rose-500 to-pink-500",
    cardBg: "from-rose-50 to-pink-50 dark:from-rose-950/20 dark:to-pink-950/20",
    iconBg: "bg-gradient-to-br from-rose-100 to-pink-100 dark:from-rose-900/30 dark:to-pink-900/30",
    borderColor: "hover:border-rose-400/50 hover:shadow-rose-400/20",
    features: ["Reading Comprehension", "Creative Writing", "Vocabulary Building", "Speaking Skills"],
    rating: 4.9,
    popular: true,
    teacher: "Mr. Johnson"
  }
      ...
      <main className="flex-grow pt-20">
        {!wingSelected ? (
          ...
          <div>
            ...
            {/* Hero Section */}
            <section className="relative py-12 sm:py-20 bg-gradient-to-br from-background via-muted/30 to-background overflow-hidden">
            ...
            <section className="py-20 sm:py-32 bg-gradient-to-b from-background to-muted/20">
              <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {filteredCourses
                    .filter(course => course.wing === activeWing || course.wing === "all")
                    .map((course, index) => (
                      <motion.div
                        key={course.id}
                        initial={{ opacity: 0, y: 20 }}
                        ...
                        whileHover={{ y: -5 }}
                        className={`bg-gradient-to-br ${course.cardBg} rounded-xl border border-border/50 shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden ${course.borderColor}`}
                      >
                        <div className={`p-6 ${course.popular ? 'pb-4' : 'pb-6'}`}>
                          <div className="flex justify-between items-start mb-4">
                            <div className={`p-3 rounded-lg ${course.iconBg}`}>
                              {course.icon}
                            </div>
                            {course.popular && (
                          ...
                          <div className="flex flex-wrap gap-2 mb-4">
                            {course.features.slice(0, 3).map((feature, idx) => (
                              <div key={idx} className="flex items-center gap-1 text-xs bg-background/50 px-2 py-1 rounded-full">
